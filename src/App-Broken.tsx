...
const App: React.FC = () => {
  ...
  const loadTemplates = async () => {
    console.log('loadTemplates: iniciando...');
    setLoading(true);
    try {
      ...
      if (error.message?.includes('supabase') || error.message?.includes('URL') || error.message?.includes('not configured')) {
        console.log('loadTemplates: ativando modo demo');
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold">Sistema OAB v3 - Melhorado</h1>
            </div>
            <button
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            {templates.length === 1 && templates[0].id === 'demo-1' && (
            ...
            {selectedTemplate && (
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-4">
                  {[...selectedTemplate.frontFields, ...selectedTemplate.backFields].map((field) => (
                    <div key={field.id}>
